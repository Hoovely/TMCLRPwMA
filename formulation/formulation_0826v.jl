...
function formulation(epsilon::Int64, cutting_num::Int64, N::Vector{Int64}, F::Vector{Int64}, G::Vector{Int64}, R::Vector{Int64}, H::Vector{Int64}, K::Vector{Int64}, Return_TMC::Vector{Int64}, service::Vector{Int64}, 
    dis::Matrix{Float64}, time::Matrix{Float64}, patient::Vector{Int64}, demand::Vector{Int64}, Capacity_VG::Int64, Capacity_VR::Int64, Capacity_H::Int64, EC_G::Int64, EC_R::Int64, VC_G::Int64, VC_R::Int64, FC::Int64, M::Int64, WG::Int64, WR::Int64)
...
function run_math(problem::String, coordinates::Vector{Vector}, cutting_num::Int64, TMC_num::Int64, green_num::Int64, red_num::Int64, hospital_num::Int64, 
    ...
    capacity_vg::Int64, capacity_vr::Int64, capacity_h::Int64, EC_G::Int64, EC_R::Int64, VC_G::Int64, VC_R::Int64, FC::Int64, M::Int64, 
    epsilon::Int64, instance_str::String, formulation_version::String)
    
    model = formulation(epsilon, cutting_num, N, F, G, R, H, K, return_tmc, service, distance_matr, time_matr, patient, demand, capacity_vg, capacity_vr, capacity_h, EC_G, EC_R, VC_G, VC_R, FC, M, WG, WR)
